        ...
        <div class="panel panel-default users-content">
            ...
            <div class="panel-body  formData" id="addForm">
                ...
                <form class="form" id="userForm">
                    ...
                    <a href="javascript:void(0);" class="btn btn-danger" onclick="$('#userForm')[0].reset()">Reset</a>
                    <a href="javascript:void(0);" class="btn btn-warning" onclick="$('#addForm').slideUp()">Hide</a>
                    <a href="javascript:void(0);" class="btn btn-success" onclick="userAction('add')">Add</a>
                </form>
            </div>
